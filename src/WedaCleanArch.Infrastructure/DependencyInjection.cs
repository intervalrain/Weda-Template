...
using WedaCleanArch.Infrastructure.Common;
using WedaCleanArch.Infrastructure.Reminders.BackgroundServices;
using WedaCleanArch.Infrastructure.Reminders.Persistence;
using WedaCleanArch.Infrastructure.Security;
using WedaCleanArch.Infrastructure.Security.CurrentUserProvider;
using WedaCleanArch.Infrastructure.Security.PolicyEnforcer;
using WedaCleanArch.Infrastructure.Security.TokenGenerator;
using WedaCleanArch.Infrastructure.Security.TokenValidation;
using WedaCleanArch.Infrastructure.Services;
using WedaCleanArch.Infrastructure.Users.Persistence;
...
public static class DependencyInjection
{
    ...
    {
        services.AddDbContext<AppDbContext>(options => options.UseSqlite("Data Source = WedaCleanArch.sqlite"));
