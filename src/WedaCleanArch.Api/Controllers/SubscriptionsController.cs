using WedaCleanArch.Application.Subscriptions.Commands.CancelSubscription;
using WedaCleanArch.Application.Subscriptions.Commands.CreateSubscription;
using WedaCleanArch.Application.Subscriptions.Common;
using WedaCleanArch.Application.Subscriptions.Queries.GetSubscription;
using WedaCleanArch.Contracts.Subscriptions;

using MediatR;

using Microsoft.AspNetCore.Mvc;

using DomainSubscriptionType = WedaCleanArch.Domain.Users.SubscriptionType;
using SubscriptionType = WedaCleanArch.Contracts.Common.SubscriptionType;

namespace WedaCleanArch.Api.Controllers;
